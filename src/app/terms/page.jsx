      ...
      <main className="flex-1 max-w-7xl mx-auto px-4 py-12 pb-24">
        <div className="space-y-12">
          ...
          <section className="p-6 rounded-lg shadow-sm">
            ...
            <p className="text-gray-700 leading-relaxed">
              You can choose Pay on Delivery for orders below Rs. 50,000. For orders above Rs. 50,000, the full amount must be paid online via credit card. For delivery, contact us at 0323228708 or 0312 2754064.
            </p>
          </section>
